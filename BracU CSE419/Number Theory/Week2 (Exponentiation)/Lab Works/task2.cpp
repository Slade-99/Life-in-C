...
int main() {
  ...
  Q.m[0][0] = 0, Q.m[0][1] = 1, Q.m[0][2] = 0 , Q.m[0][3] = 0;
  Q.m[1][0] = 0, Q.m[1][1] = 0, Q.m[1][2] = 1 , Q.m[1][3] = 0;
  Q.m[2][0] = a, Q.m[2][1] = 0, Q.m[2][2] = b , Q.m[2][3] = c;
  Q.m[3][0] = 0, Q.m[3][1] = 0, Q.m[3][2] = 0 , Q.m[3][3] = 1;
  // Q.print_matrix();
